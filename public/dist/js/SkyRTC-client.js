const SkyRTC = function () {
    ...
    skyrtc.prototype.connect = function (server, room,name) {
    ...
    skyrtc.prototype.handle_new_peerEvent = function(data){
        ...
        that.emit("alert_new_client_joined",data.socketId,data.name);
    ...
    skyrtc.prototype.handle_remove_peerEvent = function(data){
        ...
        that.emit("remove_peer_video", data.socketId);
    }
    ...
    /*************************桌面共享*******************************/
    skyrtc.prototype.shareDesktop = function (state) {
        dThat = this;
        if(state)
